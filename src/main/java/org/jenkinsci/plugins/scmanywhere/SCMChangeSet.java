...
public class SCMChangeSet extends ChangeLogSet<SCMChangeLogEntry> {
    ...
    /**
     * Object Constructor. Call the super class, initialize our variable, and set us as the parent for all of our children.
     *
     * @param build The build which caused this change log.
     * @param logs a list of SCM any where ChangeLogEntry, containing every change (commit) which has occurred since the last build.
     */
    ...
    /**
     * Returns an iterator for our SCM any where ChangeLogEntry list. This is used when generating the Web UI.
     */
